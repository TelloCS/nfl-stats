...
export const TeamRankingStatMap = [
    ...
    {
        key: 'team_coverage_stats_by_position',
        label: 'Yards Allowed By Position',
        stats: [
            { key: 'yards_allowed_wr_rank', label: 'WR'},
            { key: 'yards_allowed_te_rank', label: 'TE'},
            { key: 'yards_allowed_rb_rank', label: 'RB'},
            { key: 'yards_allowed_outside_rank', label: 'Outside'},
            { key: 'yards_allowed_slot_rank', label: 'Slot'},
        ]
    },
]
