...
import { getMatchupTeams, generateRadarData, getFilteredTeamRankingStatMap, getGameOptions } from "../utils/chartDataTransformers";
...
export default function MatchupAnalysisSection({ games, rankingData }) {
  ...
  const availableStats = useMemo(() =>
    getFilteredTeamRankingStatMap(TeamRankingStatMap, rankingData, teamOne),
    [rankingData, teamOne]
  );
  ...
  return (
    <div className="bg-geodude-900 h-full p-6 rounded-md border border-geodude-800 flex flex-col">
